 ...
 * @param <S>
 */
public class JpaLessThanOrEqualsValueCondition<E, S extends Comparable<S>> implements JpaCondition<E> {

	private String singular;

	private S value;

	public JpaLessThanOrEqualsValueCondition(String singular, S value) {
		super();
