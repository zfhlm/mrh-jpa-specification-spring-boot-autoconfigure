package org.lushen.mrh.boot.data.jpa.specification.supports.invoker;
...
import org.lushen.mrh.boot.data.jpa.specification.supports.ProxyHandler;
...
import org.lushen.mrh.boot.data.jpa.specification.supports.ProxyProvider;
 ...
 * @param <T>
 */
public class DefaultProxyInvoker<T> implements ProxyInvoker<T>, ProxyHandler {
	...
	public DefaultProxyInvoker(Class<T> proxyClass) {
		this(proxyClass, new ProxyProvider.CglibProxyProvider());
	}

	public DefaultProxyInvoker(Class<T> proxyClass, ProxyProvider proxyProvider) {
		super();
		try {
