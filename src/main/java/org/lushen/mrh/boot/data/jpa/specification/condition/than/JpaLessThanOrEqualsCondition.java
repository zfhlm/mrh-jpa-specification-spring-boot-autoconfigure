 ...
 * @param <E>
 */
public class JpaLessThanOrEqualsCondition<E> implements JpaCondition<E> {

	private String xSingular;

	private String ySingular;

	public JpaLessThanOrEqualsCondition(String xSingular, String ySingular) {
		super();
	...
	public Predicate toPredicate(Root<E> root, CriteriaBuilder criteriaBuilder) {
		return criteriaBuilder.lessThanOrEqualTo(root.get(xSingular), root.get(ySingular));
	}
