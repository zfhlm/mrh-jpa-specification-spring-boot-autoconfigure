 ...
 * @param <E>
 */
public class JpaNotEqualsValueCondition<E> implements JpaCondition<E> {

	private String singular;

	private Object value;

	public JpaNotEqualsValueCondition(String singular, Object value) {
		super();
	...
	public Predicate toPredicate(Root<E> root, CriteriaBuilder criteriaBuilder) {
		return criteriaBuilder.notEqual(root.get(singular), value);
	}
