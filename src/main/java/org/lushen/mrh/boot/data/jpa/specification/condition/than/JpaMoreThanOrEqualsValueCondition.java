 ...
 * @param <S>
 */
public class JpaMoreThanOrEqualsValueCondition<E, S extends Comparable<S>> implements JpaCondition<E> {

	private String singular;

	private S value;

	public JpaMoreThanOrEqualsValueCondition(String singular, S value) {
		super();
