 ...
 * @param <E>
 */
public class JpaLessThanCondition<E> implements JpaCondition<E> {

	private String xSingular;

	private String ySingular;

	public JpaLessThanCondition(String xSingular, String ySingular) {
		super();
	...
	public Predicate toPredicate(Root<E> root, CriteriaBuilder criteriaBuilder) {
		return criteriaBuilder.lessThan(root.get(xSingular), root.get(ySingular));
	}
